...
from posts.serializers import MyTokenObtainPairSerializer
from posts.serializers import PostsSerializer, CosmobloguserSerializer
from posts.models import Posts, Cosmobloguser
